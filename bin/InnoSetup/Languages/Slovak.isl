...
SetupFileMissing=Instalačný adresár neobsahuje súbor %1. Opravte, prosím, túto chybu alebo si zaobstarajte novú kópiu tohto produktu.
...
OnlyOnTheseArchitectures=Tento produkt je možné nainštalovat iba vo verziách MS Windows s podporou architektúry procesorov:%n%n%1
...
ErrorRegisterServerMissingExport=Nedá sa nájsť export DllRegisterServer
